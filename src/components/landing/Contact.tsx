      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-xl text-gray-400 mb-8">
            La primera consultoría es gratuita. Analizamos tu situación y te decimos honestamente si el software es la solución — y qué implicaría construirlo.
          </p>
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Si no es el momento o no es el problema correcto, te lo decimos. Sin vender por vender.</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Sin costos ocultos, sin letra chica, sin sorpresas al final.</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <form className="space-y-6">
            ...
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-gray-400 mb-2">Tu nombre</label>
              <input
                type="text"
                id="name"
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-gray-400 mb-2">Tu email</label>
              <input
                type="email"
                id="email"
            ...
            <div>
              <label htmlFor="process" className="block text-sm font-medium text-gray-400 mb-2">¿Qué proceso necesitás automatizar o mejorar?</label>
              <textarea
                id="process"
                rows={4}
