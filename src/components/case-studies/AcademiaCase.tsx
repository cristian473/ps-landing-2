	...
	return (
		<section className="relative pt-32 pb-16 lg:pt-40 lg:pb-24 overflow-hidden">
			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				...
				>
					De inscripciones por formulario de Google y cuotas en efectivo a un
					sistema que gestiona{" "}
					<span className="text-primary">1.200 alumnos, pagos y cursadas</span>{" "}
				...
				>
					Cómo una academia de capacitación dejó de perseguir alumnos por pagos
					y planillas, y unificó todo en un sistema hecho a medida.
				</motion.p>
				...
				>
					...
					<div className="prose prose-lg prose-invert max-w-none">
						<p className="text-gray-400 leading-relaxed mb-6">
							Una academia de capacitación con{" "}
							<span className="text-white font-semibold">
								1.200 alumnos activos
							</span>
							,{" "}
							<span className="text-white font-semibold">
								30 cursos simultáneos
							</span>{" "}
							y{" "}
							<span className="text-white font-semibold">
								docentes que dictan en distintos horarios
							</span>
							. Las inscripciones se tomaban por formulario de Google. Los
							pagos, en efectivo o transferencia sin sistema. La asistencia, en
							planillas por docente que nadie consolidaba.
						</p>

						<p className="text-gray-400 leading-relaxed">
							<span className="text-primary font-bold">
								Cuando un alumno preguntaba si había pagado o qué módulos le
								quedaban, la respuesta tardaba porque había que buscar en tres
								lugares distintos.
							</span>
						</p>
					</div>
	...
	const problems = [
		{
			...
			description:
				"No había forma rápida de saber quién estaba activo. Todo dependía de cruzar formularios con planillas.",
		},
		{
			icon: "money_off",
			title: "Cuotas sin registrar o sin cobrar",
			description:
				"Pagos que se cobraban sin registrar, o que directamente no se cobraban. Plata que se perdía sin saberlo.",
		},
		{
			icon: "assignment_late",
			title: "Asistencia dispersa por docente",
			description:
				"Cada docente llevaba su planilla. No había vista consolidada ni forma de saber quién faltaba regularmente.",
		},
		{
			icon: "chat_bubble_outline",
			title: "WhatsApp sin criterio ni historial",
			description:
				"Comunicación con alumnos por WhatsApp, sin registro, sin historial, sin forma de saber qué se había respondido.",
		},
	];
...
function SolutionSection() {
	const implementations = [
		{
			...
			description:
				"El alumno ve sus cursos, módulos, asistencia y estado de pagos — todo en un solo lugar",
		},
		{
			title: "Gestión de inscripciones y cuotas",
			description:
				"Con alertas automáticas de vencimiento — el sistema avisa antes de que la cuota se atrase",
		},
		{
			title: "Módulo de asistencia digital",
			description:
				"El docente registra desde el celular, la academia ve el consolidado en tiempo real",
		},
		{
			title: "Comunicaciones automáticas",
			description:
				"Recordatorios de pago, avisos de clase, certificados al finalizar — sin intervención manual",
		},
	];
	...
	const timeline = [
		...
		{
			period: "Semana 3-4",
			task: "Portal del alumno y gestión de inscripciones",
		},
		{ period: "Mes 2", task: "Sistema de cuotas y alertas automáticas" },
		{
			period: "Mes 3",
			task: "Asistencia digital y comunicaciones automáticas",
		},
	];
			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					...
					<p className="text-xl text-primary font-medium">
						Un sistema que gestiona 1.200 alumnos sin planillas — y le devuelve
						tiempo al equipo de administración.
					</p>
				</motion.div>
				...
				>
					...
					<p className="text-gray-500 text-sm mt-3 text-center">
						Cada alumno accede a sus cursos, módulos, asistencia y estado de
				...
				>
					...
					<blockquote className="relative z-10 bg-navy-surface rounded-2xl p-8 md:p-12 border border-white/10">
						<p className="text-xl md:text-2xl text-white leading-relaxed mb-6 italic">
							Antes perseguíamos a los alumnos por el pago. Ahora el sistema
							manda el aviso y ellos pagan solos.
						</p>
