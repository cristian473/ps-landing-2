	...
	return (
		<section className="relative pt-32 pb-16 lg:pt-40 lg:pb-24 overflow-hidden">
			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				...
				>
					De agenda en papel y fichas clínicas dispersas a un sistema que
					gestiona{" "}
					<span className="text-primary">
						3 sedes, 800 pacientes y facturación a obras sociales
					</span>{" "}
					— sin llamar para confirmar un turno
				</motion.h1>
				...
				>
					Cómo una clínica odontológica dejó de operar cada sede como una isla y
					unificó todo en un sistema hecho a medida.
				</motion.p>
				...
				>
					...
					<div className="prose prose-lg prose-invert max-w-none">
						<p className="text-gray-400 leading-relaxed mb-6">
							Una clínica odontológica con{" "}
							<span className="text-white font-semibold">3 sedes</span>,{" "}
							<span className="text-white font-semibold">12 profesionales</span>{" "}
							y{" "}
							<span className="text-white font-semibold">
								800 pacientes activos
							</span>
							. Los turnos se tomaban por WhatsApp o llamada. Las fichas
							clínicas, en papel o en archivos de Word sin criterio. La
							facturación a obras sociales se hacía a mano, prestación por
							prestación, y siempre quedaba algo sin cobrar.
						</p>

						<p className="text-gray-400 leading-relaxed">
							<span className="text-primary font-bold">
								Cada sede funcionaba como una isla. El dueño no tenía
								visibilidad de ninguna sin llamar.
							</span>
						</p>
					</div>
				</motion.div>
	...
	const problems = [
		{
			...
			description:
				"Sin sistema de confirmación automática, las ausencias eran constantes y la agenda un caos.",
		},
		{
			icon: "folder_off",
			title: "Fichas clínicas en papel o Word dispersas por sede",
			description:
				"Cada profesional guardaba la información a su manera. Imposible tener un historial unificado.",
		},
		{
			icon: "money_off",
			title: "Prestaciones a obras sociales sin registrar",
			description:
				"Plata que se perdía sin saberlo. Cada mes quedaban prestaciones sin facturar.",
		},
		{
			icon: "visibility_off",
			title: "Sin visibilidad centralizada",
			description:
				"Agenda, caja y rendimiento por profesional: todo disperso. El dueño no sabía qué pasaba sin llamar a cada sede.",
		},
	];
...
function SolutionSection() {
	const implementations = [
		{
			...
			description:
				"Con confirmación automática por WhatsApp — el paciente confirma con un click",
		},
		{
			title: "Historia clínica digital por paciente",
			description:
				"Odontograma, tratamientos, fotos — todo en un solo lugar, accesible desde cualquier sede",
		},
		{
			title: "Módulo de facturación a obras sociales",
			description:
				"Prestaciones registradas automáticamente al cerrar el turno — nada queda sin facturar",
		},
		{
			title: "Panel central",
			description:
				"Caja diaria, ocupación de agenda y rendimiento por profesional — visible desde el celular",
		},
	];
	...
	const timeline = [
		...
		{
			period: "Semana 3-4",
			task: "Agenda online y confirmaciones automáticas",
		},
			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					...
					<p className="text-xl text-primary font-medium">
						Un sistema que unifica las 3 sedes y le da visibilidad total al
						dueño — sin depender de llamadas ni planillas.
					</p>
				</motion.div>
				...
				>
					...
					<p className="text-gray-500 text-sm mt-3 text-center">
						Historial clínico, odontograma y tratamientos accesibles desde
						cualquier sede
					</p>
				</motion.div>
			</div>
				...
				>
					...
					<blockquote className="relative z-10 bg-navy-surface rounded-2xl p-8 md:p-12 border border-white/10">
						<p className="text-xl md:text-2xl text-white leading-relaxed mb-6 italic">
							Antes no sabía cuánto habíamos facturado hasta que cerraba el mes.
							Ahora lo veo en tiempo real desde el celular.
						</p>
