		...
		<section className="relative pt-32 pb-16 lg:pt-40 lg:pb-24 overflow-hidden">
			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				...
				>
					...
					<span className="text-primary">300 órdenes por semana</span> sin
					intervención manual
				</motion.h1>
				...
				>
					Cómo una distribuidora con 180 clientes empresariales dejó de perder
					pedidos, errores de precio y horas de administración — con un sistema
					hecho exactamente para su operación.
				</motion.p>
				...
				>
					...
					<div className="prose prose-lg prose-invert max-w-none">
						<p className="text-gray-400 leading-relaxed mb-6">
							Una distribuidora que vende insumos a empresas.{" "}
							<span className="text-white font-semibold">
								180 clientes activos
							</span>
							. Cada uno con su precio acordado, su límite de crédito, sus
							condiciones de pago.
						</p>
						...
						<p className="text-gray-400 leading-relaxed mb-6">
							Los pedidos llegaban por WhatsApp. Los precios vivían en un Excel
							que solo una persona sabía leer. Las cuentas corrientes se
							controlaban en otra planilla. Y cuando algo fallaba — un precio
							mal aplicado, un pedido que se perdió — nadie sabía bien dónde
							estaba el error.
						</p>
...
function SolutionSection() {
	...
	const timeline = [
		...
		{
			period: "Semana 3-4",
			task: "Portal funcionando con los primeros 10 clientes en producción",
		},
			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					...
					<p className="text-xl text-primary font-medium">
						Un portal B2B propio. Cada cliente entra con su usuario, ve sus
						precios, hace su pedido y ve el estado en tiempo real. Sin
						intermediario.
					</p>
				</motion.div>
				...
				>
					...
					<p className="text-gray-500 text-sm mt-3 text-center">
						Vista del backoffice donde el equipo interno gestiona pedidos,
						clientes y precios
					</p>
				</motion.div>
			</div>
				...
				>
					...
					<blockquote className="relative z-10 bg-navy-surface rounded-2xl p-8 md:p-12 border border-white/10">
						<p className="text-xl md:text-2xl text-white leading-relaxed mb-6 italic">
							Antes, tomar un pedido eran tres pasos y dos personas. Ahora el
							cliente lo hace solo y nosotros nos enteramos cuando ya está
							confirmado.
						</p>
