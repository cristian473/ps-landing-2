			...
			<footer className="bg-black py-8 border-t border-white/5">
				<div className="max-w-4xl mx-auto px-4 text-center">
					<p className="text-gray-500 text-sm">
						&copy; {new Date().getFullYear()} Puro Software. Todos los derechos
						reservados.
					</p>
				</div>
			</footer>
			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
				...
				>
					...
					<span className="text-primary">
						400 propiedades, visitas y contratos
					</span>{" "}
				...
				>
					Cómo una inmobiliaria con 15 asesores dejó de operar con herramientas
					genéricas y armó su propio sistema de gestión: propiedades, clientes,
					visitas, contratos y comisiones en un solo lugar.
				</motion.p>
				...
				>
					...
					<div className="prose prose-lg prose-invert max-w-none">
						<p className="text-gray-400 leading-relaxed mb-6">
							Una inmobiliaria mediana.{" "}
							<span className="text-white font-semibold">15 asesores</span>,{" "}
							<span className="text-white font-semibold">
								400 propiedades activas
							</span>
							, operaciones de venta y alquiler en simultáneo.
						</p>

						<p className="text-gray-400 leading-relaxed mb-6">
							Cada asesor trabajaba a su manera. Uno llevaba sus contactos en el
							celular. Otro en una planilla. El CRM que probaron duró tres meses
							antes de que nadie lo usara más. Los contratos se guardaban en
							carpetas de Drive sin criterio. Y las comisiones se calculaban a
							fin de mes con una calculadora y discusiones incluidas.
						</p>

						<p className="text-gray-400 leading-relaxed">
							<span className="text-primary font-bold">
								No era desorden por falta de ganas. Era desorden porque ninguna
								herramienta encajaba con cómo trabajaban.
							</span>
						</p>
					</div>
				</motion.div>
	...
	const problems = [
		{
			...
			description:
				"Cada asesor sabía lo suyo. El dueño de la inmobiliaria no sabía cuántas visitas había en la semana ni qué propiedades estaban calientes.",
		},
		{
			icon: "content_copy",
			title: "Propiedades duplicadas o desactualizadas",
			description:
				"La misma propiedad cargada dos veces, con precios distintos, por dos asesores diferentes.",
		},
		{
			icon: "folder_off",
			title: "Contratos sin trazabilidad",
			description:
				"Alquiler que vence, renovación que nadie avisó, depósito que no se registró. Todo en carpetas de Drive que nadie organizaba igual.",
		},
		{
			icon: "calculate",
...
function SolutionSection() {
	const implementations = [
		{
			...
			description:
				"Una sola fuente de verdad: precio, estado, fotos, documentos, historial",
		},
		{
			title: "Pipeline de clientes por asesor",
			description:
				"Cada uno ve sus contactos, sus visitas agendadas y el estado de cada operación",
		},
		{
			title: "Gestión de contratos de alquiler",
			description:
				"Vencimientos, depósitos y ajustes por índice con alertas automáticas",
		},
		{
			title: "Calculadora de comisiones automática",
			description:
				"Cada cierre registrado genera el cálculo automático según las reglas de la inmobiliaria",
		},
		{
			title: "Panel gerencial",
			description:
				"Visibilidad total: cuántas operaciones hay en curso, qué asesores están activos, qué propiedades no se movieron en 60 días",
		},
	];
	...
	const timeline = [
		...
		{
			period: "Semana 3-4",
			task: "Cartera de propiedades y pipeline de clientes",
		},
			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					...
					<p className="text-xl text-primary font-medium">
						Un sistema hecho para cómo trabaja una inmobiliaria real. No un CRM
						genérico que hay que forzar para que encaje.
					</p>
				</motion.div>
						...
						{timeline.map((item, index) => (
							<div key={item.period} className="flex items-center gap-4">
								...
								<div className="flex-1 flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
									<span className="text-primary font-semibold text-sm min-w-[100px]">
										{item.period}
									</span>
	...
	return (
		<section className="py-16 lg:py-24 bg-background-dark">
			<div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					{/* Quote marks */}
					<div className="absolute -top-4 -left-4 text-8xl text-primary/20 font-serif leading-none">
						"
					</div>
					...
					<blockquote className="relative z-10 bg-navy-surface rounded-2xl p-8 md:p-12 border border-white/10">
						<p className="text-xl md:text-2xl text-white leading-relaxed mb-6 italic">
							Antes no sabía qué estaban haciendo mis asesores hasta que me
							contaban. Ahora abro el panel y en dos minutos tengo todo.
						</p>
			...
			<div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
				...
				>
					...
					<p className="text-lg text-gray-400 mb-10">
						Tomamos 2 proyectos por trimestre. Si esto resuena, tiene sentido
						hablarlo.
					</p>
					<a
						href="https://wa.me/5491164039597?text=Hola%2C%20vi%20el%20caso%20de%20la%20inmobiliaria%20y%20me%20interesa%20un%20sistema%20similar%20para%20gestionar%20propiedades%20y%20contratos."
						target="_blank"
